...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_adress = findViewById(R.id.editText5);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (et_name == null || et_name.getText().toString().equals("")
            ...
            newData.setAdress(et_adress.getText().toString());
            ...
            if (bitmap != null){
                ...
                StorageReference storageReference = mStorageRef.child("CustomerPictures/" + getSharedPreferences("pref",MODE_PRIVATE).getString("username", "") + "/" + "profile_picture.png");
                storageReference.putFile(uri);
            }

            //Launch the normal use
            Intent profile = new Intent(RegisterActivity.this, MainActivity.class);
